...
describe('Unit tests for CRUD operations on different end points', () => {
          ...
          "questions" : [
            {
              ...
              "answers" : [
                ...
                {"option" : "Vijayawada"}, {"option" : "noida"}
              ],
              "answer" : 2,
              "isEnabled" : true,
            ...
            },
            {
              ...
              "answers" : [
                {"option" : "new york"}, {"option" : "dc"}, {"option" : "qwer"},
                {"option" : "mumbai"}
              ],
              "answer" : 2,
              "isEnabled" : true,
  ...
  it('OK, Added a new question', (done) => {
    request(app)
        ...
        .send({
          ...
          "answers" : [
            {"option" : "new york"}, {"option" : "Tokyo"},
            {"option" : "Vijayawada"}, {"option" : "berlin"}
          ],
          "answer" : 2,
          "isEnabled" : true,
          "explanation" : "Something"
  ...
  it('OK, Getting data from the end point /quizes/:quizId/questions/:questionId',
     (done) => {
       request(app)
  ...
  it('OK, Getting data from the end point /quizes/:quizId/questions',
     (done) => {
       request(app)
